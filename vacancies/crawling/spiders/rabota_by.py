...
class RabotaBySpider(scrapy.Spider):
    ...
    def parse_vacancy(self, response):
        ...
        yield {
            ...
            'description': sub_response.xpath('.//div[@data-qa="vacancy-description"]').get(),
            'skills': normalize_selector_list(sub_response.xpath('//div[@data-qa="bloko-tag bloko-tag_inline skills-element"]')),
            'posted': sub_response.xpath('normalize-space(.//p[@class="vacancy-creation-time"])').get()
        }
